...
class ArtistHandler {
    ...
    func all(artists completion: @escaping (_ artists: [Artist]?, _ error: Error?) -> (Void)) {
        ...
        self.artists(with: nil) { artists, error in
    ...
    ///     - artists: The fetched artists.
    ///     - error: If the request failed the error can provide more information about the failure reason.
    func artists(with objectIDs: [Int]?, completion: @escaping (_ artists: [Artist]?, _ error: Error?) -> (Void)) {
 
        self.webservice.fetch("artist", with: objectIDs, including: ["image", "link", "tag"]) { (objects, err) -> (Void) in
    ...
    func links(for artistID: Int, completion: @escaping (_ links: [Link]?, _ error: Error?) -> (Void)) {
        ...
        self.webservice.fetchResource("links", for: "artist", with: artistID, including: nil) { (resources, error) -> (Void) in
    ...
    func tags(for artistID: Int, completion: @escaping (_ tags: [Tag]?, _ error: Error?) -> (Void)) {
        ...
        self.webservice.fetchResource("tags", for: "artist", with: artistID, including: nil) { (resources, error) -> (Void) in
    ...
    func image(for artistID: Int, completion: @escaping (_ image: ImageRef?, _ error: Error?) -> (Void)) {
        ...
        self.webservice.fetchResource("image", for: "artist", with: artistID, including: nil) { (resources, error) -> (Void) in
