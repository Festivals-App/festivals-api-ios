...
class LocationHandler {
    ...
    func all(locations completion: @escaping (_ locations: [Location]?, _ error: Error?) -> (Void)) {
        ...
        self.locations(with: nil) { locations, error in
    ...
    ///     - locations: The fetched locations.
    ///     - error: If the request failed the error can provide more information about the failure reason.
    func locations(with objectIDs: [Int]?, completion: @escaping (_ locations: [Location]?, _ error: Error?) -> (Void)) {
        
        self.webservice.fetch("location", with: objectIDs, including: ["image", "link", "place"]) { (objects, err) -> (Void) in
    ...
    func links(for locationID: Int, completion: @escaping (_ links: [Link]?, _ error: Error?) -> (Void)) {
        ...
        self.webservice.fetchResource("links", for: "location", with: locationID, including: nil) { (resources, error) -> (Void) in
    ...
    func place(for locationID: Int, completion: @escaping (_ place: Place?, _ error: Error?) -> (Void)) {
        ...
        self.webservice.fetchResource("place", for: "location", with: locationID, including: nil) { (resources, error) -> (Void) in
    ...
    func image(for locationID: Int, completion: @escaping (_ image: ImageRef?, _ error: Error?) -> (Void)) {
        ...
        self.webservice.fetchResource("image", for: "location", with: locationID, including: nil) { (resources, error) -> (Void) in
