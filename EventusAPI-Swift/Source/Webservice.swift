...
/// The errors used by the webservice class.
...
class Webservice: NSObject {
    ...
    func fetch(_ objectType: String, with ids: [Int]?, including relationships: [String]?, completion: @escaping (_ objects: [Any]?, _ error: Error?) -> (Void)) {
    ...
    ///     - error: If the request failed the error can provide more information about the failure reason.
    func fetchResource(_ resourceType: String, for objectType: String, with id: Int, including relationships: [String]?, completion: @escaping (_ resources: [Any]?, _ error: Error?) -> (Void)) {
    ...
    func perfrom(_ request: URLRequest, result: @escaping (_ data: [Any]?, _ error: Error?) -> (Void)) {
        ...
        self.session.dataTask(with: request) { (data, response, err) in
            ...
            guard  let _ = response as? HTTPURLResponse else{
                result(nil, WebserviceError.requestFailed)
                return
            }
            ...
            guard let dataArray = self.dataArrayFrom(jsonData) else {
                result(nil, WebserviceError.serviceError)
                return
            }
    ...
    func makeFetchQuery(with objectType: String, _ objectIDs: [Int]?, including relationships: [String]?) -> String {
